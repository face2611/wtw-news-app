// Generated by Wrangler by running `wrangler types` (hash: d34df49c3a6548650c016ba127ef0e9a)
// Runtime types generated with workerd@1.20250317.0 2025-02-14 nodejs_compat
declare namespace Cloudflare {
  interface Env {
    CORS_ORIGIN: 'http://127.0.0.1:3000' | 'https://news.iliane.xyz';
    DATABASE_URL: string;
    SECRET_KEY: string;
